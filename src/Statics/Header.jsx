...
const Header = ({ searchTerm, setSearchTerm, onProductSelect  }) => {
  ...
  useEffect(() => {
    // you can replace this with a fetch from props or API if needed
            ...
            <div className="relative w-full">
              ...
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#523523] hover:bg-[#5c3c28] text-white p-2 rounded-md transition-colors">
                <Search className="w-4 h-4 lg:w-5 lg:h-5" />
                   ...
                   {/* Dropdown */}
                   {showDropdown && (
              <div className="absolute mt-12 w-full bg-white shadow-lg rounded-md max-h-64 overflow-y-auto z-50">
